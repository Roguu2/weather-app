    ...
    <section className="max-w-8xl w-4/5 h-full m-3">
      ...
      {showData && (
        ...
        >
          ...
          >
            <div className="w-[100%] h-[33%] lg:w-[33%] lg:h-[100%] bg-white/40 dark:bg-white/10  lg:bg-transparent lg:dark:bg-transparent backdrop-blur-sm rounded-3xl p-2 lg:p-0">
            ...
            <div className="w-[100%] h-[33%] lg:w-[33%] lg:h-[100%] bg-white/40 dark:bg-white/10 lg:bg-transparent lg:dark:bg-transparent backdrop-blur-sm rounded-3xl p-2 lg:p-0 my-4">
              <Weather
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-2 items-center justify-items-center w-[100%] h-[33%] lg:w-[33%] lg:h-[100%] bg-white/40 dark:bg-white/10  lg:bg-transparent lg:dark:bg-transparent backdrop-blur-sm rounded-3xl p-2 lg:p-0">
              <WeatherStats
                statName={"Clouds"}
